package com.gorczycait.vidaday.presentation.common.navigation
        ...
        when (targetState.destination.route) {
            ...
            in screensWithCloseAction -> when (initialState.destination.route) {
                in screensWithCloseAction -> slideIntoContainer(
                    ...
                    animationSpec = tween(com.gorczycait.vidaday.presentation.common.navigation.TRANSITION_DURATION),
                )
