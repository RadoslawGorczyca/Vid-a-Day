...
object BackbonesTypography {
    ...
    val DISPLAY_XXL_BOLD: TextStyle = TextStyle(
        fontFamily = com.gorczycait.vidaday.presentation.common.theme.bigShoulders,
        fontWeight = Bold,
        fontSize = 96.sp,
        lineHeight = 104.sp,
        letterSpacing = (-1).sp,
    ...
    val HEADER_XXL_BOLD: TextStyle = TextStyle(
        fontFamily = com.gorczycait.vidaday.presentation.common.theme.sora,
        fontWeight = Bold,
        fontSize = 32.sp,
        lineHeight = 44.sp,
        letterSpacing = 0.sp,
    ...
    val Body_L_Medium: TextStyle = TextStyle(
        fontFamily = com.gorczycait.vidaday.presentation.common.theme.inter,
        fontWeight = Medium,
        fontSize = 16.sp,
        lineHeight = 24.sp,
        letterSpacing = (-0.2).sp,
    ...
    val Patch_JaneAusten_S: TextStyle = TextStyle(
        fontFamily = com.gorczycait.vidaday.presentation.common.theme.janeAusten,
        fontWeight = Normal,
        fontSize = 16.sp,
        letterSpacing = 0.sp,
    )
    ...
    val Patch_Komoda_S: TextStyle = TextStyle(
        fontFamily = com.gorczycait.vidaday.presentation.common.theme.komoda,
        fontWeight = Normal,
        fontSize = 24.sp,
        letterSpacing = 0.sp,
    )
    ...
    val Patch_EFNRebook_S: TextStyle = TextStyle(
        fontFamily = com.gorczycait.vidaday.presentation.common.theme.efnRebook,
        fontWeight = Normal,
        fontSize = 16.sp,
        letterSpacing = 0.sp,
    )
